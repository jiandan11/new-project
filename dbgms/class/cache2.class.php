 ...
 * 模式2 缓存存储方式 <?php // mktime: 1318224645 return array ( 'contents' => array ( 0 => 1, 1 => 2, 2 => 3, 3 => 34, 4 => 5,
 * 5 => 6, 6 => 6, ), 'expire' => 0, 'mtime' => 1318224645, ) ?>
 */

cache::setCacheMode ( '1' );

if(! $row = cache::get ( 'zj2sad' ))
{
	$array = array(
			1,
			2,
