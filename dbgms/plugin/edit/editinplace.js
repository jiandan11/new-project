...
$.fn.editInPlace.defaults = {
	...
	bg_over:			"transparent", // string: background color of hover of unactivated editor
	...
	default_text:		"(点击添加)", // string: text to show up if the element that has this functionality is empty
	...
	select_text:		"选择", // string: default text to show up in select box
...
$.extend(InlineEditor.prototype, {
	...
	createEditorElement: function() {
		...
		if ("select" === this.settings.field_type)
			...
			editor = $('<input style="width:auto" type="text" ' + this.inputNameAndClass() 
				+ ' size="' + this.settings.text_size  + '" />');
		else if ("textarea" === this.settings.field_type)
			editor = $('<textarea style="width:auto" ' + this.inputNameAndClass() 
