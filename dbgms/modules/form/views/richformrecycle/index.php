 ...
 <div class="dbg_top">
  <div class="span_r">
   <form name="DbgMsFormSearch" id="DbgMsFormSearch" action="<?php echo $curr_url;?>" method="get">
    <input type="hidden" name="con" value="richformrecycle" />
...
<!--    <td><?php //echo $val['description'];?></td>-->
    ...
    <td>
        <a onclick="dbgmsOperate('<?php echo $resuscitate_url.$val['rfid'];?>')">【恢复】</a>
        <a onclick="dbgmsDelete('<?php echo $delete_url.$val['rfid'];?>')">【删掉】</a>
<!--        <a class="overview-a" href="<?php echo 'form?con=richform&page='.$page.'&act=overview&rfid='. $val['rfid'];?>" target="_blank">【预览】</a>-->
    </td>
   </tr>
<?php endforeach;?>
      <tr class="btm">
