...
<div class="dbg_warp">
 <form method="post" id="DbgMsFormEdit" name="DbgMsFormEdit" enctype="multipart/form-data">
  ...
  <input type="hidden" readonly="readonly" value="<?php echo $row['rid'];?>" name="rid" />
   ...
   <table class="subtab">
    <tbody>
     <tr>
      ...
      <td>
       <div class="hpft">
           <input type="text" class="itxt biaoci" name="rname" id="name" style="width: 474px" value="<?php echo $row['rname'];?>" placeholder="请输入富表单元素名称">
       </div>
      </td>
     </tr>
     <tr>
      ...
      <td>
       <div class="hpft">
        <select name="bid" id="DbgMsColumnSelect" onchange="visiblespan()">
           ...
           <option value="<?php echo $key;?>" <?php if($row['bid'] == $key):?>selected="selected"<?php endif;?>><?php echo $value['type'];?>--<?php echo $value['description'];?></option>
           <?php endforeach;?>
        </select>
       </div>
      </td>
      ...
      <td>
       <div class="hpft">
        <select name="gid" id="groupDbgMsColumnSelect" onchange="visiblespan()">
           ...
           <option value="<?php echo $value['id'];?>" <?php if($row['gid'] == $value['id']):?>selected="selected"<?php endif;?>><?php echo $value['name'];?>--<?php echo $value['description'];?></option>
           <?php endforeach;?>
        </select>
        <?php foreach ($groups as $key => $value) :?>
     ...
     <tr>
      ...
      <td>
       <div class="hpft">
           <textarea name="description" style="width: 474px" rows="3" cols="20" maxlength="96"><?php echo $row['description'];?></textarea>
       </div>
      </td>
     </tr>
     <tr>
      ...
      <td>
       <div class="hpft">
           <textarea name="attrstyle" style="width: 474px" rows="3" cols="20" maxlength="96" placeholder="可不填，输入类似 style='background-color:red;'"><?php echo $row['attrstyle'];?></textarea>
       </div>
      </td>
     </tr>
    </tbody>
