<div class="dbgms_tabs_wrap">
 <h2>
  <a href="<?php echo $curr_url;?>">富表单元素js事件列表</a> <font style="color: #666;">&nbsp;&gt;&gt;&nbsp;</font> 创建
 </h2>
</div>
<!--  -->
<div class="dbg_warp">
   ...
   <table class="subtab">
    <tbody>
     <tr>
      ...
      <td>
       <div class="hpft">
        <input type="text" class="itxt biaoci" name="jsename" id="title" style="width: 474px">
       </div>
      </td>
     </tr>
     <tr>
      ...
      <td>
       <div class="hpft">
           <input type="text" class="itxt biaoci" name="eventname" id="title" style="width: 474px" placeholder="例如onclick">
       </div>
      </td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td>
       <div class="hpft">
           <input type="text" class="itxt biaoci" name="functionname" id="title" style="width: 474px" placeholder="例如test">
       </div>
      </td>
     </tr>
     <tr>
      ...
      <td>
       <div class="hpft">
        <textarea name="functioncode" id="title" style="width: 474px" rows="30" cols="20"></textarea>
       </div>
      </td>
     </tr>
    </tbody>
