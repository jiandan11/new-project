...
<div class="dbgms_tabs_wrap">
 <h2>
  <a href="<?php echo $con_url;?>">TAG管理</a> <font style="color: #666;">&nbsp;&gt;&gt;&nbsp;</font> 编辑
 </h2>
</div>
<div class="dbg_warp">
...
<div class="dbg_warp">
 <div class="dbg_top">
  <span class="span_l"><a class="dbgms_btn" href="<?php echo $con_url;?>&act=edit">新增TAG</a></span><span class="span_r"><input type="button" value="更新所有缓存" class="dbgms_btn" onclick="upcache()"> </span>
 </div>
 <table class="tblist">
  <thead>
   <tr>
