...
<div class="dbgms_tabs_wrap">
 <h2>
  <a href="<?php echo $con_url;?>">碎片管理</a> <font style="color: #666;">&nbsp;&gt;&gt;&nbsp;</font> 编辑
 </h2>
</div>
  ...
  <table class="subtab">
   <tbody>
    ...
    <?php if($enablelanguage == 1):?>
        <?php $diyf['form']='DbgMsFormEdit';$diyf['name']='碎片英文内容';$diyf['field']='econtent';dbg_diyfield ( 'load', 'ueditor', $diyf,$row['econtent'] );?>
    <?php endif;?>
...
<div class="dbg_warp">
 <div class="dbg_top">
  <span class="span_l"><a class="dbgms_btn" href="<?php echo $con_url;?>&act=edit">新增碎片</a></span><span class="span_r"><input type="button" value="更新所有缓存" class="dbgms_btn"> </span>
 </div>
 <table class="tblist">
  <thead>
   <tr>
