...
// 对话框使用
// createDialog({
// title : transKeyWords(globelVary.languageId, 8),
// con : transKeyWords(globelVary.languageId, 11),
// type : "error",
// width : 300
// }, [ {
// name : transKeyWords(globelVary.languageId, 5),
// action : function() {
// closeDialog("all");
// }
// } ]);
...
function siteSearch(){
	$("#siteSearchSubmit").click(function(){ 
		...
		// window.open("/default.asp?act=contentfind&searchClass="+siteSearchClass+"&searchContent="+siteSearchContent);
		// //跳转新页面
...
function commonSearch(userLabelId){	
	$("#searchSubmit"+userLabelId).click(function(){ 
		...
		// window.open("/default.asp?act=contentfind&searchClass="+searchClass+"&searchContent="+searchContent);
		// //跳转新页面
...
/**
 * jQuery jPages v0.4 Client side pagination with jQuery
...
(function ( $, window, document, undefined ) {
    ...
    var name = "jPages",
        ...
        defaults = {
            ...
            animation    : "", // http://daneden.me/animate/ - any entrance
								// animations
            fallback     : 400,
            minHeight    : true,
...
/** ************QQ功能*********************** */
/*
 * 此插件基于Jquery 插件名：jquery.Sonline(在线客服插件) 作者 似懂非懂 版本 2.0 Blog：www.haw86.com
 */
(function($){
...
/** **********放大镜插件(二):使用二张图片的思路**************** */
/*
 * <div class="test"><!--整个放大效果的最外区域.--> <div class="testOri"><img
 * width="400px" height="250px" src="../img/small.jpg" alt="原图"/></div><!--原始区域,为了更好地兼容各种浏览器,请将图片的宽和高注明-->
 * <div class="testZoom"><img width="1440px" height="900px"
 * src="../img/big.jpg" alt="放大图"/></div><!--放大区域,为了更好地兼容各种浏览器,请将图片的宽和高注明-->
 * </div> $(".test").bnFdjTwo({ ori: ".testOri", zoom: ".testZoom" });
 */
...
function getRegData(className){
			...
			$("."+className,$(".user_login_form")).each(function() {
				...
				/*
				 * else if(type=="password"){ getStr(name,$(this).val()); }
				 */				
				else{
					n=2;
					return false;
...
function controlTimeMashine(){// 登录后调用,开始计时
	 ...
	 * if(value==""){//session无值,无需做超时处理 return true; } else{//已登录
	 */
