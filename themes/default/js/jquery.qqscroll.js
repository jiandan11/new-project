(function($){
    ...
    $.fn.qqScroll = function (options){
        ...
        var obj = $(this);
        var scroller = {};
            scroller.turnslist = opts.turnslist;
        ...
        scroller.fn = {
            ...
            turns:function(_dis){
                // console.log(_dis/scroller.moveVal);
                            if(opts.isRace){
                                var pageNum = _dis/scroller.moveVal;
                                // console.log(pageNum);
                                switch(pageNum){
                                    case 1:
                                    case 2:
                                    case 3:
                                        opts.showTurns.html(2);
                                    break;
                                    case 4:
                                    case 5:
                                        opts.showTurns.html(3);
                                    break;
                                    case 6:
                                    case 7:
                                        opts.showTurns.html(4);
                                    break;
                                    case 8:
                                        opts.showTurns.html(5);
                                    break;
                                    case 9:
                                    case 10:
                                    case 11:
                                        opts.showTurns.html(6);
                                    break;
                                    case 0:
                                    case 12:
                                        opts.showTurns.html(1);
                                    break;
                                    default:
                                    break;
                                }
