 ...
 */;(function ($) {
    ...
    $.smallslider = function (elm, options) {
        ...
        _this.createButtons = function () {
            ...
            var left = 0,
                ...
                bottom = 0;
            var style_btns = {};
            switch (_this.opts.buttonrecommend) {
                case 'leftTop':
        ...
        _this.createText = function () {
            ...
            if (_this.opts.textrecommend) {
                switch (_this.opts.textrecommend) {
                    case 'top':
                        style_tex.left = 0;
                        style_tex.top = 0;
                        break;
                ...
                _this.textrecommend = _this.opts.textrecommend;
            }
        ...
        _this.slideText = function (index) {
            if (_this.opts.showText) {
                ...
                if (_this.opts.textSwitch > 0) {
                    ...
                    } else if (_this.textrecommend == 'bottom') {
                        t_ani1 = {
                            bottom: -1 * t_path
                        };
                        t_ani2 = {
    ...
    $.smallslider.defaults = {
        ...
        buttonrecommend: 'rightBottom', // 按钮位置表示，共有四个值：leftTop，leftBottom，rightTop，rightBottom
        ...
        textrecommend: 'bottom', // 标题栏的位置，默认为空，即和按钮的位置一致，取值 top , bottom
